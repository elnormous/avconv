...
#define LIBAV_CONFIGURATION "--prefix=/usr --libdir=/usr/lib64 --enable-libx264 --enable-gpl --enable-libbmd --enable-libfdk-aac --enable-nonfree --enable-libfreetype --enable-libfontconfig"
#define LIBAV_LICENSE "nonfree and unredistributable"
#define AVCONV_DATADIR "/usr/share/avconv"
#define CC_IDENT "gcc 4.8.3 (GCC) 20140911 (Red Hat 4.8.3-9)"
